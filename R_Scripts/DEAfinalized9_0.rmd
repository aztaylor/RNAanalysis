...
analyzer <- OptimizedLDAAnalyzer$new(
  master_df = Master_df,
  go_corpus_col = "GO_corpus"  # Column containing GO terms
)

# Execute optimized pipeline
results <- analyzer$
  prepare_dtm(p_sparse = 0.94)$    # Remove 94% sparse terms
  find_optimal_k(k_range = 3:11)$  # Parallel tuning
  fit_lda()$                       # Uses auto-detected k
  visualize_topics()

# Access results
print(results$k_metrics)
plot(results$visualize_topics())

# Save diagnostic plots
ggsave("optimal_k.png", FindTopicsNumber_plot(results$k_metrics))
```
