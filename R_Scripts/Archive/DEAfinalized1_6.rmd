...
se18$timepoint <- factor(se18$timepoint)
...
sorted_sig_res5s4 <- res5s4[order(sig_res5s4$log2FoldChange, decreasing = TRUE), ]
sorted_sig_res18s4 <- res18s4[order(sig_res18s4$log2FoldChange, decreasing = TRUE), ]
print(sorted_sig_res5s4)

l2f_5_s4 <- as.data.frame(na.omit(sorted_sig_res5s4$log2FoldChange))
rownames(l2f_5_s4) <- rownames(sorted_sig_res18s4[!is.na(sorted_sig_res5s4)])
#l2f_5_s4 <- l2f_5_s4[topgenes5s4, , drop=FALSE]
#l2f_5_s4$rownames <- topgenes5s4
#colnames("WT 5hr untreated vs. st 18hr treated")

l2f_18_s4 <- as.data.frame(na.omit(sorted_sig_res18s4$log2FoldChange))
rownames(l2f_18_s4) <- rownames(sorted_sig_res5s4[!is.na(sorted_sig_res5s4)])
