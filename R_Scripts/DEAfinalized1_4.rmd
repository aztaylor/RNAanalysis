...
l2f_matrix <- cbind(l2f_5_NC[topgenes,], l2f_5_s4[topgenes,], l2f_18_NC[topgenes,], l2f_18_s4[topgenes,])
rownames(l2f_matrix) <- topgenes
colnames(l2f_matrix) <- c("CasRx-gRNA Negative Control", "CasRx-gRNA Spacer 5", "CasRx-gRNA Negative Control", "CasRx-gRNA Spacer 5")
